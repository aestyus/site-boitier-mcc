...
export default function ClientsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDateNaissance(initialValues.dateNaissance);
    setNombrePoints(initialValues.nombrePoints);
    setErrors({});
  };
  const validations = {
    nom: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Clients(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ClientsCreateForm")}
      {...rest}
    >
      <TextField
        label="Nom"
